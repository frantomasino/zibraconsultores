  ...
  return (
    <section className="bg-accent py-20 md:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-accent-foreground mb-6 text-balance">{t("cta.title")}</h2>
        <p className="text-lg text-accent-foreground/90 mb-8 max-w-2xl mx-auto leading-relaxed">{t("cta.subtitle")}</p>
        ...
        <p className="text-sm text-accent-foreground/80 mt-8">{t("cta.note")}</p>
      </div>
    </section>
  )
}
